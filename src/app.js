...
//api level validation(for username, emailId, password), hashing password
...
app.get("/login", async (req, res) => {
  // validate the user entered emailId
  // find wether emailId is present or not
  // if present, take the password and compare with stored password
  // once compared password is true then allow login
  try {
    ...
    const loginPs = await bcrypt.compare(password, user.password);
